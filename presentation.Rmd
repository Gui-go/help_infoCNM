...
- Scripts Introdução ao R 1 e 2

- Rmarkdown do IPCA através do pacote sidrar, pdf e html
...
- Gráfico do excedente do consumidor - ggplot2

- App Excedente do consumidor - Shiny
